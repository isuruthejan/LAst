...
<html>
  <head>
    <title>results | Malabe Boys' school Technology Society</title>
    <meta charset="utf-8"/>
  ...
  <body bgcolor="2e2929">
    ...
    <article>
        ...
        <div>
            <p>Sorry for the inconvenience but we&rsquo;re performing some maintenance at the moment. If you need to you can always <a href="contact">contact us</a>, otherwise we&rsquo;ll be back online shortly!</p>
            <p>&mdash; The Team</p>
    ...
    <script>
        const countDown = () => {
            const countDay = new Date('August 16, 2024 09:00:00');
            const now = new Date();
