...
<head>
  ...
  <title>download | Malabe Boys' school Technology Society</title>
...
<body class="font-Noto-Sans">
  ...
  <!-- Header -->
  <header class="w-full bg-[url('https://i.ibb.co/0MZkGvT/leaves.jpg')] bg-cover bg-bottom">  
    <div class="w-full min-h-screen md:w-1/2 bg-gradient-to-b from-gray-900/90 to-gray-900/95 p-10 flex">
      <div class="w-full text-center my-auto">
        <h1 class="font-bold  text-amber-00 mb-10 md:ext-4xl md:text-5xl lg:text-6xl mb-14 md:-mr-20 text-white md:text-right">Past Peapers Download</h1>
        ...
        <!-- Content -->
        <p class="text-base mb-10 text-gray-200 md:text-right">Soon As Possible </p>

       

  <script>
    // Change the value of countDownEndDate to the day you want to end the count down
    var countDownEndDate = "August 16, 2024 09:00:00";
